...
- (CGRect)getPopupFrameForViewController:(UIViewController *)viewController {
    ...
    return CGRectMake(x + viewController.popupViewOffset.x, y + viewController.popupViewOffset.y - self.navigationController.navigationBar.frame.size.height, frame.size.width, frame.size.height);
}
